...
class Elementor_Widget_Swiper_Ospiti extends \Elementor\Widget_Base {

    public function __construct($data = [], $args = null) {
        parent::__construct($data, $args);
        wp_register_style('swiper-ospiti-css', plugins_url('swiper-ospiti.css', __FILE__));
    }

    public function get_style_depends() {
        return ['swiper-ospiti-css'];
    }

    public function get_name() {
        return 'swiper_ospiti';
    }

    public function get_title() {
        return __('Swiper Ospiti', 'elementor_addon');
    }
    ...
    protected function render() {
        ...
        <div class="swiper-ospiti-widget" id="swiper-ospiti-<?php echo esc_attr($widget_id); ?>">
            <div class="swiper">
                <div class="swiper-wrapper">
                    <?php foreach ($settings['guests_list'] as $index => $guest) : ?>
                        <div class="swiper-slide">
                            <div class="ospite-card">
        ...
        (function () {
            ...
            function initSwiperOspiti(container) {
            ...
            function init() {
                var container = document.getElementById("swiper-ospiti-<?php echo esc_attr($widget_id); ?>");
                if (container) {
                    initSwiperOspiti(container);
                }
            }
            ...
            if (window.elementorFrontend) {
                window.elementorFrontend.hooks.addAction(
                    "frontend/element_ready/swiper_ospiti.default",
                    function ($scope) {
                        var container = $scope[0].querySelector(".swiper-ospiti-widget");
                        if (container) {
                            initSwiperOspiti(container);
                        }
                    }
