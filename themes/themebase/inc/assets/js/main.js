...
(function () {
    ...
    function getRoundedRectPoints(w, h, r, spacing) {
        ...
        for (var i = 0; i < count; i++) {
            ...
            if (d < topLen) {
                ...
                x = w - r - (d - topLen - 2 * cornerLen - rightLen); y = h;
                ...
                x = 0; y = h - r - (d - 2 * topLen - 3 * cornerLen - rightLen);
            } else {
    ...
    function initAllCf7DotButtons() {
        ...
        forms.forEach(function (form, idx) {
            ...
            if (realP) {
                realP.style.cssText = 'position:absolute;opacity:0;width:1px;height:1px;overflow:hidden;pointer-events:none;';
            } else {
                realInput.style.cssText = 'position:absolute;opacity:0;width:1px;height:1px;overflow:hidden;pointer-events:none;';
            }
            ...
            widget.innerHTML =
                '<div class="dot-button-link">' +
                    ...
                    '<span class="dot-button-inner">' +
                        '<span class="dot-button-text" style="color:' + TEXT_COLOR + ';" data-split-hover>' + text + '</span>' +
                        '<span class="dot-button-arrow" style="color:' + ARROW_COLOR + ';" data-split-hover>\u2192</span>' +
                    '</span>' +
                '</div>';
            ...
            if (submitRow) {
                ...
                (realP || realInput).parentNode.insertBefore(widget, realP || realInput);
            }
